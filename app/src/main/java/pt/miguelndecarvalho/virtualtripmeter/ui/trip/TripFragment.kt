...
class TripFragment : Fragment() {
        ...
        doc.get()
            .addOnSuccessListener { document ->
                if (document != null) {
                    ...
                    {
                        mView.findViewById<TextView>(R.id.totalKM).text = getString(R.string.trip_unitMiles)
                        mView.findViewById<TextView>(R.id.partialKM).text = getString(R.string.trip_unitMiles)
                        mView.findViewById<TextView>(R.id.velocityUnity).text = getString(R.string.trip_unitMilesHour)
                    }
                    setupButtons(mView)
                }
            }
    ...
    fun setupButtons(mView: View)
    {
        ...
        mView.findViewById<ImageButton>(R.id.start_button).setOnClickListener{
            // TODO: 7/2/21  
        }
